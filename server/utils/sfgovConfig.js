module.exports = {
  ...
  // createAlamedaContestIdsArray: function() {
  //   var alamedaContestIds = [];
  //   for(var i = 13; i < 145; i++) {
  //     alamedaContestIds.push(i.toString());
  //   }
  //   console.log(alamedaContestIds);
  // },
  ...
  raceFilter: {
    ...
    "State Senate": ["District 3", "District 7", "District 9", "District 10", "District 11",
